...
public class VentanaBorraryModificar extends javax.swing.JDialog {
    ...
    private void llenarCombo()
    {
        try
        {
            Controlador.llenarlugar(jcLugar,String.valueOf(jcNombreEvento.getSelectedItem()));
        }
        catch (Exception e)
        {
            showMessageDialog(this,e.getMessage());
    ...
    public void comprobarlugar()
    {
        try
        {
            if (Controlador.comprolugar(String.valueOf(jcLugar.getSelectedItem()),String.valueOf(jcNombreEvento.getSelectedItem())))
               throw new Exception("YA HAY UN EVENTO A ESAS HORAS EN EL LUGAR");
            
            Controlador.modificarlugar(String.valueOf(jcLugar.getSelectedItem()),String.valueOf(jcNombreEvento.getSelectedItem()),this);
        }
        catch (Exception e)
        {
            showMessageDialog(this,e.getMessage());
    ...
    public void modificaraforo()
    {
        try
        {
            Controlador.modificaraforo(aforo,String.valueOf(jcNombreEvento.getSelectedItem()),this);
        }
        catch(Exception e)
        {
            showMessageDialog(this,e.getMessage());
    ...
    public void comprobarfecha()
    {
       try
       {
           ...
           Controlador.modificarfechayhora(fecha,horai,horaf,this,String.valueOf(jcNombreEvento.getSelectedItem()));
       }
       catch (Exception e)
       {
           showMessageDialog(this,e.getMessage());
    ...
    private void jfFechaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jfFechaActionPerformed
        try
        {
            ...
            if (!Controlador.comprobarfecha(fecha,String.valueOf(jcNombreEvento.getSelectedItem())))
    ...
    private void jfAforoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jfAforoActionPerformed
        try
        {
             ...
             if (aforo <= Controlador.cantidadaforo(String.valueOf(jcNombreEvento.getSelectedItem())))
